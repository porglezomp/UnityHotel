...
public class EditorObjExporter : ScriptableObject
{
	...
	[MenuItem ("Custom/Export/Export to lightmap")]
	static void ExportLightmap()
	{
		GameObject[] transforms = (FindObjectsOfType(typeof (MeshRenderer)) as GameObject[]);
		
		if (transforms.Length == 0)
        {
        	EditorUtility.DisplayDialog("No objects in scene!", "Please build your scene before attempting to export it", "");
        	return;
        }
